                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="clientSecret" id="clientSecret" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="clientUri" id="clientUri" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="redirectUri" id="redirectUri" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="radio" name="trusted" value="true" class="icheck" > 是
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="trusted" value="false" class="icheck" checked="checked"> 否
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="accessTokenValidity" id="accessTokenValidity" value="43200" class="form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="refreshTokenValidity" id="refreshTokenValidity" value="2592000" class="form-control">
                                            <span class="help-inline">单位: 秒</span>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#submitBtn").click(function () {
            krt.ajax({
                type: "POST",
                url: "${basePath}/oauth/clientDetails/insert",
