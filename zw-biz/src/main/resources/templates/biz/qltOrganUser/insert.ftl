                                ...
                                <div class="row">
                                                ...
                                                <div class="box-body box-profile">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-12" style="text-align: center">
                                                            <input type="radio" class="icheck" name="sex" value="0"
                                                                   checked> 男
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="col-sm-7">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="password" class="control-label col-sm-4">
                                                        <span class="form-required">*</span>用户密码
                                                        ：</label>
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input type="password" name="password" id="password"
                                                                   class="form-control" placeholder="请输入密码"
                                                                   rangelength="6,20" required>
                                                            <div class="input-group-addon">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input type="password" name="password2" id="password2"
                                                                   ...
                                                                   equalTo="#password" rangelength="6,20" required>
                                                            <div class="input-group-addon">
                                                                <i class="fa fa-unlock-alt"></i>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="organName" class="control-label col-sm-4">请选择科室或岗位：</label>
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <!-- 参数 -->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="col-sm-offset-5 col-sm-7">
                                                ...
                                                <button type="button" id="closeIframeBtn" class="btn btn-danger"><i
                                                            class="fa fa-close"></i> 关闭
                                                </button>
                                                <button type="reset" id="resetBtn" class="btn btn-default"><i
