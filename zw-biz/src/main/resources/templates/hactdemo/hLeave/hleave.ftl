                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="title" name="title" value="${hleave.title!}" class="form-control" readonly required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="day" name="day" value="${hleave.day!}" class="form-control" readonly required >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="2" name="reason" class="form-control" readonly required>${hleave.reason!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
