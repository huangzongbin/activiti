...
public class ApiPushController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", dataType = "String", name = "accessToken", value = "accessToken", required = true),
    ...
    public ReturnBean bindToken(String registrationId, String appType, @ApiIgnore @KrtLoginUser User user) throws InvocationTargetException, IllegalAccessException {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", dataType = "String", name = "accessToken", value = "token", required = true)
    })
    public ReturnBean<Integer> unbindPushToken(@ApiIgnore @KrtLoginUser User user) throws InvocationTargetException, IllegalAccessException {
    ...
    public ReturnBean push(@RequestBody PushDTO pushDTO) throws InvocationTargetException, IllegalAccessException {
        log.debug("============推送开始============");
