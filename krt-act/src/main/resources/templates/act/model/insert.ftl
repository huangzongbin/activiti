                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="hidden" name="extBusinessId" readonly id="extBusinessId" class="form-control">
                                                <input type="text" name="extBusinessName" readonly id="extBusinessName" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="4" name="description" class="form-control" rangelength="1,50"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(function () {
            ...
            validateForm = $("#krtForm").validate({
                rules: {
                    username: {
                        remote: {
                            url: "${basePath}/sys/user/checkActKey",
                            type: "post",
                            dataType: "json",
                            async: false,
                            data: {
