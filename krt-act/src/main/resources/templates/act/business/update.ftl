                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="pname" readonly value="${(pBusiness.name)!}" id="pname" class="form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="name" name="name" value="${business.name!}" class="form-control" rangelength="1,30" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="actKey" name="actKey" value="${business.actKey!}" class="form-control">
                                            ...
                                            <select class="form-control select2" style="width: 100%" id="type" name="type" required>
                                                ...
                                                <@dic type="act_business_type" ; dicList>
                                                    <#list dicList as item>
                                                        <option value="${item.code}" ${(business.type==item.code)?string("selected","")}>${item.name}</option>
                                                    </#list>
                                                </@dic>
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="classUrl" name="classUrl" value="${business.classUrl!}" class="form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="sort" name="sort" value="${business.sort!}" class="form-control" digits="true" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="4" name="remark" class="form-control" rangelength="1,50">${business.remark!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<@footer>
    <script type="text/javascript">
        ...
        function doSubmit() {
            krt.ajax({
                type: "POST",
                url: "${basePath}/act/business/update",
